...
var ExtendedAngularMarkdownService = /** @class */ (function (_super) {
    __extends(ExtendedAngularMarkdownService, _super);
    function ExtendedAngularMarkdownService(angularHtmlService) {
        var _this = _super.call(this, angularHtmlService) || this;
        _this.angularHtmlService = angularHtmlService;
        _this.markdownService = new MarkdownService(DefaultOptions.getDefault(), MarkdownDefaultExtensions);
        return _this;
    }
    ExtendedAngularMarkdownService = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [AngularHtmlService])
    ], ExtendedAngularMarkdownService);
    return ExtendedAngularMarkdownService;
}(AngularMarkdownService));
export { ExtendedAngularMarkdownService };
//# sourceMappingURL=extended-angular-markdown.service.js.map