...
export declare class CommonDocDataServiceStub {
    ...
    newSearchResult(tdocSearchForm: CommonDocSearchForm, recordCount: number, currentRecords: CommonDocRecord[], facets: Facets): CommonDocSearchResult<CommonDocRecord, CommonDocSearchForm>;
}
