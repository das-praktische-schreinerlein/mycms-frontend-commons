...
var CommonDocAssignJoinFormComponent = /** @class */ (function (_super) {
    ...
    function CommonDocAssignJoinFormComponent(fb, activeModal, cd, searchFormUtils, cdocDataService, toastr) {
    ...
    CommonDocAssignJoinFormComponent.prototype.ngOnInit = function () {
        this.updateData();
    };
    CommonDocAssignJoinFormComponent.prototype.onCancel = function () {
        this.activeModal.close('Cancel click');
        this.resultObservable.error('canceled');
        return false;
    };
    CommonDocAssignJoinFormComponent.prototype.onSubmitAssignKey = function () {
    ...
    CommonDocAssignJoinFormComponent.prototype.updateData = function () {
        var changes = {};
    ...
    CommonDocAssignJoinFormComponent.prototype.checkForm = function () {
    ...
    CommonDocAssignJoinFormComponent.prototype.onUpdateReferenceField = function () {
    ...
    CommonDocAssignJoinFormComponent.prototype.onUpdateNewIdSelect = function () {
        this.assignFormGroup.patchValue({ newIdOption: 'select' });
        this.checkFormAndSetValidFlag();
        return false;
    };
    CommonDocAssignJoinFormComponent.prototype.checkFormAndSetValidFlag = function (event) {
        if (this.checkForm()) {
    ...
    CommonDocAssignJoinFormComponent.prototype.getSearchTypeForRecordType = function (type) {
        return type;
    };
    CommonDocAssignJoinFormComponent.prototype.updateSelectFields = function () {
        var me = this;
        ...
        for (var _b = 0, facetNames_1 = facetNames; _b < facetNames_1.length; _b++) {
            ...
            facetValues.push(['label.assignjoin.reference.', facetName, '', facetName]);
        }
    ...
    CommonDocAssignJoinFormComponent.prototype.getCurrentReferenceField = function () {
    ...
    CommonDocAssignJoinFormComponent.prototype.generateSelectIdValues = function (facetName, keyValues) {
    ...
    ], CommonDocAssignJoinFormComponent.prototype, "records", void 0);
    __decorate([
        Input(),
        __metadata("design:type", Subject)
    ], CommonDocAssignJoinFormComponent.prototype, "resultObservable", void 0);
