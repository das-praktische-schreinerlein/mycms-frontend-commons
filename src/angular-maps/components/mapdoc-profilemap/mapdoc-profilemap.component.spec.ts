...
import {MapDocProfileMapComponent} from './mapdoc-profilemap.component';
...
describe('TourDocProfileMapComponent', () => {
    let component: MapDocProfileMapComponent;
    let fixture: ComponentFixture<MapDocProfileMapComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [MapDocProfileMapComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(MapDocProfileMapComponent);
